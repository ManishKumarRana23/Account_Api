...
namespace AccountMicroservice.Repository
{
    ...
    {
        int acid = 1;
        Uri baseAddress = new Uri("https://localhost:44348/api");   //Port No.
        HttpClient client;
        ...
        public static List<accountStatement> accountStatements = new List<accountStatement>()
        {
            ...
            statements= new List<statement>()
            {
                ...
                new statement{date=27092020,narration="Deposited",refNumber=21345,valueDate=03022020,withdrawal=0.00,deposit=2000.00,closingBalance=3000.00}
                }
            },
        ...
        {
             new customerAccount{customerId=1,currentAccountId=101,savingsAccountId=102},
        ...
        public static List<currentAccountDetails> currentAccounts = new List<currentAccountDetails>()
        {
            new currentAccountDetails{currentAccountId=201,currentAccountBalance=1000},
             new currentAccountDetails{currentAccountId=101,currentAccountBalance=2000}
        };
        public static List<savingsAccount> savingsAccounts = new List<savingsAccount>()
        {
            new savingsAccount{savingsAccountId=202,savingsAccountbalance=5000},
             new savingsAccount{savingsAccountId=102,savingsAccountbalance=2000}
        };
        ...
        public IEnumerable<statement> getAccountStatement(int accountId, int fromDate, int toDate)
        {
            ...
            var accs1 = accountStatements.Where(a => a.accountId == accountId).FirstOrDefault();
           var s1 = accountStatements.Find(a => a.accountId == accountId).statements;
